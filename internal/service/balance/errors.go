...
var (
	...
	// ErrProcessAccrualsNotStarted is the error returned when new accrual order arrives while accrual proccessing hasn't started yet
	...
	// ErrInsufficientFunds is the error returned when a user balance have become negative after a withdrawal
