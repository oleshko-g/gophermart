...
// New instantiates HTTP handlers for all the balance service endpoints using
...
func (s *Server) Service() string { return "balance" }
...
func (s *Server) MethodNames() []string { return balance.MethodNames[:] }
